...
$result_usuario = "INSERT INTO clientes ( `nome` , `email` , `sexo` , `ddd` , `telefone` , `endereço` , `cidade` , `estado` , `bairro` , `cep` , `país` , `news` , `id` ) 
VALUES ('$nome', '$email', '$sexo', '$ddd', '$tel', '$endereco', '$cidade', '$estado', '$bairro','$cep', '$pais', '$news', '')";
...
<head>
	...
	<link rel="stylesheet" href="css/InsertClientes.css" >
<meta http-equiv="refresh" content="8;url=ConsultaProfissionais.php">	
